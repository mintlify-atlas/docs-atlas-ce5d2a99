...
Follow the [installation guide](/getting-started/installation), then install FinQA dependencies:
...
<CardGroup cols={2}>
  <Card title="Tool Agents" icon="tools" href="/core-concepts/agents">
    Learn more about building tool agents
  </Card>
  <Card title="Training" icon="graduation-cap" href="/tutorials/training">
    Explore training configurations
  </Card>
  <Card title="Community Projects" icon="users" href="/projects/community">
