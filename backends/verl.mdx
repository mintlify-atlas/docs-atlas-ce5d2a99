...
<ParamField path="algorithm.lam" type="float" default="0.95">
...
<ParamField path="resource_pool_config.critic_gpu" type="integer">
...
<CardGroup cols={2}>
  ...
  <Card title="Agent Trainer" icon="robot" href="/customize/agent-trainer">
